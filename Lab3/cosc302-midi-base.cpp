...
COSC302_Midi::~COSC302_Midi()
{
  destroy_nd();
  destroy_el();
}

void COSC302_Midi::destroy_el()
{
...
COSC302_Midi::COSC302_Midi(string file)
{
  EventList::iterator eit;
  ifstream fin;
  string s;
...
void COSC302_Midi::Add_Pause(double starttime, double duration)
{
  EventList::iterator eit;
  int ttime;
  int iduration;
...
void COSC302_Midi::Scale(double factor)
{
  NDMap::iterator mit;
  ND *n;
  NDMap *newmap;
...
void COSC302_Midi::Write(string file, char format)
{
  FILE *f;
  EventList::iterator eit;
  NDMap::iterator nit;
